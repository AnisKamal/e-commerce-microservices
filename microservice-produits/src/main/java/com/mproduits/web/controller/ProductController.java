...
public class ProductController {
    ...
    @Autowired 
    ApplicationPropertiesConfiguration appProprties ; 
    ...
    public List<Product> listeDesProduits(){
       ...
       // logger.info("Recuperation de la liste ! "); 
        
        List<Product> listeLimitee = products.subList(0, appProprties.getLimiteDeProduits() );
